...
class SettingsScreen extends StatelessWidget {
  ...
  Widget _buildSettingsTile(IconData icon, String title, AppThemeColors c) {
    const double horPadding = 16.0;
    const double verPadding = 18.0;
    ...
    return Container(
      ...
      padding: const EdgeInsets.symmetric(horizontal: horPadding, vertical: verPadding),
      ...
      child: Row(
        children: [
          Icon(icon, color: c.textSecondary, size: iconSize),
